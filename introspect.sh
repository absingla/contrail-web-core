...
DEST_CHROME_EXTN=./$WEB_CONTROLLER/webroot/chrome-extension/introspect
...
rm -rf ./$DEST_CHROME_EXTN/contrail-web-core
rm -rf ./$DEST_CHROME_EXTN/contrail-web-controller
