...
define([
    ...
    function formatUIWhereClauseConfigByMember (key, list) {
        return formatUIWhereClauseConfigByAdmin(key, list);
    }

    function formatUIWhereClauseConfigByAdmin (key, list) {
