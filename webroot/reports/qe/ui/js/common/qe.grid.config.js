    ...
    var QEGridConfig = function () {
        ...
        this.getColumnDisplay4ChartGroupGrid = function(tableName, tableType, selectArray) {
            var newColumnDisplay = [],
                columnDisplay = this.getColumnDisplay4Grid(tableName, tableType, selectArray);
        ...
        this.getOnClickSessionAnalyzer = function(clickOutView, queryId, queryFormAttributes) {
        ...
        this.setAnalyzerIconFormatter = function() {
