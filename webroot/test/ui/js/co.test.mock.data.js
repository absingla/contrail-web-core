...
define(['underscore'], function (_) {
    ...
    var disabledFeatureMockData = {"disabled":["config_alarms","mon_infra_mx"]},
        ...
        ctWebServerInfoMockData = _.extend({}, webServerInfoMockData,
            {"featurePkg": { "webController": true }},
            {"featurePkgsInfo": { "webController": true }, optFeatureList:{"config_alarms": true,"mon_infra_mx": true}}),
        smWebServerInfoMockData = _.extend({}, webServerInfoMockData,
            {"featurePkg": { "serverManager": true }},
            {"featurePkgsInfo": { "serverManager": true }, optFeatureList:{"config_alarms": true,"mon_infra_mx": true}}),
        sWebServerInfoMockData = _.extend({}, webServerInfoMockData,
            {"featurePkg": { "webStorage": true }},
            {"featurePkgsInfo": { "webStorage": true }, optFeatureList:{"config_alarms": true,"mon_infra_mx": true}});
